...
- add popup error message to let the user know to fill in all data points for nyquizt plots if they aren't filled out
...
class Application:
    def __init__(self, parent):
        ...
        tk.Label(self.data_panel, text="425°C", anchor=tk.W).grid(row=2, column=0)
        tk.Label(self.data_panel, text="450°C", anchor=tk.W).grid(row=3, column=0)
        tk.Label(self.data_panel, text="475°C", anchor=tk.W).grid(row=4, column=0)
        tk.Label(self.data_panel, text="500°C", anchor=tk.W).grid(row=5, column=0)
        tk.Label(self.data_panel, text="525°C", anchor=tk.W).grid(row=6, column=0)
        tk.Label(self.data_panel, text="550°C", anchor=tk.W).grid(row=7, column=0)
        tk.Label(self.data_panel, text="575°C", anchor=tk.W).grid(row=8, column=0)
        tk.Label(self.data_panel, text="600°C", anchor=tk.W).grid(row=9, column=0)
        tk.Label(self.data_panel, text="625°C", anchor=tk.W).grid(row=10, column=0)
        tk.Label(self.data_panel, text="650°C", anchor=tk.W).grid(row=11, column=0)
        tk.Label(self.data_panel, text="675°C", anchor=tk.W).grid(row=12, column=0)
        tk.Label(self.data_panel, text="700°C", anchor=tk.W).grid(row=13, column=0)
        ...
        self.intercept_1_425 = tk.Entry(self.data_panel, width=6)
        self.intercept_1_425.grid(row = 2, column = 1)
        self.intercept_2_425 = tk.Entry(self.data_panel, width=6)
        self.intercept_2_425.grid(row = 2, column = 2)
        self.intercept_1_450 = tk.Entry(self.data_panel, width=6)
        self.intercept_1_450.grid(row = 3, column = 1)        
        self.intercept_2_450 = tk.Entry(self.data_panel, width=6)
        self.intercept_2_450.grid(row = 3, column = 2)  
        self.intercept_1_475 = tk.Entry(self.data_panel, width=6)
        self.intercept_1_475.grid(row = 4, column = 1)
        self.intercept_2_475 = tk.Entry(self.data_panel, width=6)
        self.intercept_2_475.grid(row = 4, column = 2)
        self.intercept_1_500 = tk.Entry(self.data_panel, width=6)
        self.intercept_1_500.grid(row = 5, column = 1)
        self.intercept_2_500 = tk.Entry(self.data_panel, width=6)
        self.intercept_2_500.grid(row = 5, column = 2)
        self.intercept_1_525 = tk.Entry(self.data_panel, width=6)
        self.intercept_1_525.grid(row = 6, column = 1)
        self.intercept_2_525 = tk.Entry(self.data_panel, width=6)
        self.intercept_2_525.grid(row = 6, column = 2)
        self.intercept_1_550 = tk.Entry(self.data_panel, width=6)
        self.intercept_1_550.grid(row = 7, column = 1)
        self.intercept_2_550 = tk.Entry(self.data_panel, width=6)
        self.intercept_2_550.grid(row = 7, column = 2)
        self.intercept_1_575 = tk.Entry(self.data_panel, width=6)
        self.intercept_1_575.grid(row = 8, column = 1)
        self.intercept_2_575 = tk.Entry(self.data_panel, width=6)
        self.intercept_2_575.grid(row = 8, column = 2)
        self.intercept_1_600 = tk.Entry(self.data_panel, width=6)
        self.intercept_1_600.grid(row = 9, column = 1)
        self.intercept_2_600 = tk.Entry(self.data_panel, width=6)
        self.intercept_2_600.grid(row = 9, column = 2)
        self.intercept_1_625 = tk.Entry(self.data_panel, width=6)
        self.intercept_1_625.grid(row = 10, column = 1)
        self.intercept_2_625 = tk.Entry(self.data_panel, width=6)
        self.intercept_2_625.grid(row = 10, column = 2)
        self.intercept_1_650 = tk.Entry(self.data_panel, width=6)
        self.intercept_1_650.grid(row = 11, column = 1)
        self.intercept_2_650 = tk.Entry(self.data_panel, width=6)
        self.intercept_2_650.grid(row = 11, column = 2)
        self.intercept_1_675 = tk.Entry(self.data_panel, width=6)
        self.intercept_1_675.grid(row = 12, column = 1)
        self.intercept_2_675 = tk.Entry(self.data_panel, width=6)
        self.intercept_2_675.grid(row = 12, column = 2)
        self.intercept_1_700 = tk.Entry(self.data_panel, width=6)
        self.intercept_1_700.grid(row = 13, column = 1)
        self.intercept_2_700 = tk.Entry(self.data_panel, width=6)
        self.intercept_2_700.grid(row = 13, column = 2)  
        ...
        self.plot_425_button = tk.Button(self.data_panel, text='Plot', command=lambda: self.plot_isotherm(2)) #plot command    
        self.plot_425_button.grid(row=2, column=3)
        self.plot_450_button = tk.Button(self.data_panel, text='Plot', command=lambda: self.plot_isotherm(3)) #plot command    
        self.plot_450_button.grid(row=3, column=3)
        self.plot_475_button = tk.Button(self.data_panel, text='Plot', command=lambda: self.plot_isotherm(4)) #plot command    
        self.plot_475_button.grid(row=4, column=3)
        self.plot_500_button = tk.Button(self.data_panel, text='Plot', command=lambda: self.plot_isotherm(5)) #plot command    
        self.plot_500_button.grid(row=5, column=3)
        self.plot_525_button = tk.Button(self.data_panel, text='Plot', command=lambda: self.plot_isotherm(6)) #plot command    
        self.plot_525_button.grid(row=6, column=3)
        self.plot_550_button = tk.Button(self.data_panel, text='Plot', command=lambda: self.plot_isotherm(7)) #plot command    
        self.plot_550_button.grid(row=7, column=3)
        self.plot_575_button = tk.Button(self.data_panel, text='Plot', command=lambda: self.plot_isotherm(8)) #plot command    
        self.plot_575_button.grid(row=8, column=3)
        self.plot_600_button = tk.Button(self.data_panel, text='Plot', command=lambda: self.plot_isotherm(9)) #plot command    
        self.plot_600_button.grid(row=9, column=3)
        self.plot_625_button = tk.Button(self.data_panel, text='Plot', command=lambda: self.plot_isotherm(10)) #plot command    
        self.plot_625_button.grid(row=10, column=3)
        self.plot_650_button = tk.Button(self.data_panel, text='Plot', command=lambda: self.plot_isotherm(11)) #plot command    
        self.plot_650_button.grid(row=11, column=3)
        self.plot_675_button = tk.Button(self.data_panel, text='Plot', command=lambda: self.plot_isotherm(12)) #plot command    
        self.plot_675_button.grid(row=12, column=3)
        self.plot_700_button = tk.Button(self.data_panel, text='Plot', command=lambda: self.plot_isotherm(13)) #plot command    
        self.plot_700_button.grid(row=13, column=3)
    ...
    def eis_file_path(self, button_number, dir_path):
        ...
        temp_range = ['400°C', '425°C', '450°C', '475°C', '500°C', '525°C', '550°C','575°C', '600°C', '625°C', '650°C', '675°C', '700°C',]
    ...
    def get_entries(self):
        ...
        intercept_1_entries = [
        self.intercept_1_400,
        self.intercept_1_425,
        self.intercept_1_450,
        self.intercept_1_475,
        self.intercept_1_500,
        self.intercept_1_525,
        self.intercept_1_550,
        self.intercept_1_575,
        self.intercept_1_600,
        self.intercept_1_625,
        self.intercept_1_650,
        self.intercept_1_675,
        self.intercept_1_700,]
        
        intercept_2_entries = [
        self.intercept_2_400,
        self.intercept_2_425,
        self.intercept_2_450,
        self.intercept_2_475,
        self.intercept_2_500,
        self.intercept_2_525,
        self.intercept_2_550,
        self.intercept_2_575,
        self.intercept_2_600,
        self.intercept_2_625,
        self.intercept_2_650,
        self.intercept_2_675,
        ...
        for intercept_1_entry, intercept_2_entry in zip(intercept_1_entries, intercept_2_entries):      
            if intercept_1_entry is "":
                intercept_1_entry = 0
                        
            if intercept_2_entry is "":
                intercept_2_entry = 0
...
def get_isotherm_plot_data(dir_location, temperature ):
    raw_impedance_data = pd.read_csv(filepath_or_buffer=dir_location ,delim_whitespace=True, index_col=0,header=None, skiprows=0, names=[
        'Frequency/Hz',
        'impedance R/Ohm',
        'impedance I/Ohm',])
...
def get_rp_plot_data():
    ...
    temperatures = np.array([400, 425, 450, 475, 500,525, 550, 575, 600, 625, 650, 675, 700])
